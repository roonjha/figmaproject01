  ...
  return (
    <nav className="bg-white shadow-md py-3">
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        {/* Navigation Links */}
        <div className="hidden md:flex space-x-14 ml-[12%]">
          <Link href="/" className="text-gray-700 hover:text-gray-900">
            Home
          </Link>
          <Link href="/newarrivals" className="text-gray-700 hover:text-gray-900">
            New Arrivals
          </Link>
        ...
        <div className="flex items-center border rounded-lg overflow-hidden w-full max-w-md">
          <input
            ...
            onChange={handleSearchChange}  // Trigger search on every keystroke
          />
        ...
        <Link href="/cart" className="text-gray-700 hover:text-gray-900">
          <div className="flex items-center space-x-0 font-extrabold">Cart
            <button>
              <svg
