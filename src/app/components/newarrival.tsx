  ...
  return (
    <section className="bg-[#F2F0F1] py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-8" style={{ fontFamily: 'Integral CF, sans-serif', fontWeight: 'bold' }}>
          NEW ARRIVALS
        </h2>
        <hr className="border-t border-gray-500 mx-auto w-1/2 mb-10" />
        ...
        <br></br>
      <hr className="border-t border-gray-300 mx-auto w-1/2 mb-8" />
